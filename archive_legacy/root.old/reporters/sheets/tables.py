...
from reporters.sheets.config import STD_NAVY, STD_WHITE
from reporters.sheets.view_state import set_freeze_panes_safe
...
def adjust_sheet_format(writer, sheet_name):
    ...
    """
    from reporters.sheets.tables_impl import adjust_sheet_format as _impl
...
def apply_tab_hyperlinks(writer):
    ...
    Args:
        writer: Pandas ExcelWriter-like object.
    """
    from reporters.sheets.tables_impl import apply_tab_hyperlinks as _impl

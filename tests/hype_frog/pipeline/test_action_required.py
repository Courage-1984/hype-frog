...
def test_determine_action_required_needs_optimization_when_seo_low() -> None:
    assert determine_action_required({"Copy Score": 80.0, "SEO Score": None}) == "Needs Optimization"
    assert determine_action_required({"Copy Score": 90.0, "SEO Score": 49.9}) == "Needs Optimization"

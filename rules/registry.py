...
from config import DEFAULT_EFFORT_BY_SEVERITY, DEFAULT_OWNER_BY_SEVERITY
...
SEVERITY_PRIORITY_BASE = {"Critical": 100, "Warning": 65, "Info": 35}
AGING_BY_SEVERITY = {"Critical": "Immediate (Current Sprint)", "Warning": "Next Sprint", "Info": "Backlog"}
...
def root_cause_and_fix(issue_name: str) -> tuple[str, str]:
    mapping = {
        ...
        "No FAQ/QA Schema": ("No FAQPage/QAPage schema found for likely Q&A style content.", "Add valid FAQPage or QAPage JSON-LD where appropriate and ensure on-page parity."),
        ...
        "No 40-60 Word Answer Paragraphs": ("No concise answer-length paragraph detected.", "Add a direct 40-60 word answer summary near question headings."),
